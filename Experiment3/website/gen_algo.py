...
csv_file_path = 'C:/Users/Adrian/Desktop/HTML Guide 2/Capstone/Experiment3/csvs/things.csv'
cake = 'C:/Users/Adrian/Desktop/HTML Guide 2/Capstone/Experiment3/csvs/cake.csv'
caterer = 'C:/Users/Adrian/Desktop/HTML Guide 2/Capstone/Experiment3/csvs/caterer.csv'
balloons = 'C:/Users/Adrian/Desktop/HTML Guide 2/Capstone/Experiment3/csvs/balloons.csv'
photographer = 'C:/Users/Adrian/Desktop/HTML Guide 2/Capstone/Experiment3/csvs/photographer.csv'
# csv_file_path = 'C:/Users/Adrian/Desktop/HTML Guide 2/Capstone/Experiment3/csvs/supplier_list.csv'
...
# # Read the CSV file and extract the data into supplier_list
# with open(suppliers, mode='r', newline='', encoding='utf-8') as file:
...
with open(caterer, mode='r', newline='') as csv_file:
    csv_reader = csv.DictReader(csv_file)
    for row in csv_reader:
        thing = Thing(name=row['name'], rating=int(row['rating']), price=float(row['price']))
        caterer_arr.append(thing)

with open(balloons, mode='r', newline='') as csv_file:
    csv_reader = csv.DictReader(csv_file)
    for row in csv_reader:
        thing = Thing(name=row['name'], rating=int(row['rating']), price=float(row['price']))
        balloons_arr.append(thing)
...
cake1 = cake_arr
caterer1 = caterer_arr
balloons1 = balloons_arr
photographer1 = photographer_arr
supplier_list1 = supplier_list
